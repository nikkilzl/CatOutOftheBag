<footer class='footer'>
    <div class="footer-content">
        <div class="footer-left-content">
            <div>Contact Us</div>
            <div>Email: <a style="text-decoration:none;" href="mailto:enquiry@catoutofthebag.com">enquiry@catoutofthebag.com</a></div>
            <div>Phone: +65 6123 4567</div>
        </div>
    ...
    <div class="copyright">
        <p>Copyright &copy;  2022 COTB All rights reserved</p>
    </div>
</footer>