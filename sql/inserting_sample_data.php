...
$password_hashed = md5('testtest');
$sql .= "INSERT INTO Account (username, password)
VALUES ('testtest', '$password_hashed');";
...
$sql .= "INSERT INTO CustomerDetails (accountId, fullName, email, phoneNumber, dateOfBirth, address)
VALUES ( (SELECT accountId from Account where username = 'testtest'), 'testtest', 'testtest@gmail.com', '83066382', '2000-08-01', '');";
...
VALUES ( 'Acer Nitro 5 AN515-43-R5V8', 1298, 'laptop', 4.2, 100, 
'Acer Nitro 5 AN515-43-R5V8 NEW 120Hz Refresh Rate Gaming laptop with AMD Ryzen 5 processor and GTX 1650 Graphics\n
Part No : NH.Q6ZSG.001\n
AMD Ryzen 5 3550H quad-core processor\n
Windows 10 Home\n
NVIDIA GeForce GTX 1650 4GB GDDR5',
'{\"brand\": \"acer\", \"ships from\": \"29 International Business Park, Loading Bay, Bay, SG\"}',
'https://cf.shopee.sg/file/f9d387ee4ece4eead393205c951d044b', 1);";
...
'https://cf.shopee.sg/file/19f48f79d40a0a31d3c27bc49ed1b577', 0);";
